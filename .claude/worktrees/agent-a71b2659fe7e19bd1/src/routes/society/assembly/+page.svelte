	...
	<div class="page-content">
		{#if currentAssembly}
			<details class="assembly-section card-border">
				<summary class="assembly-summary">
					<div>
						<h2 class="section-title t-prose">Current Term (#{currentAssembly.term_number})</h2>
						<p class="term-dates">
		...
		{#if followingAssembly}
			<details class="assembly-section card-border">
				<summary class="assembly-summary">
					<div>
						<h2 class="section-title t-prose">Following Term (#{followingAssembly.term_number})</h2>
						<p class="term-dates">
		...
		{#if precedingAssembly}
			<details class="assembly-section card-border">
				<summary class="assembly-summary">
					<div>
						<h2 class="section-title t-prose">Preceding Term (#{precedingAssembly.term_number})</h2>
						<p class="term-dates">
