...
<div class="page-container">
	...
	<div class="page-content">
		...
		<div class="demurrage-section">
			<h2 class="section-title t-prose">Supply Reconciliation</h2>
		...
		<div class="demurrage-section">
			<h2 class="section-title t-prose">Run Demurrage</h2>
		...
		<div class="universal-allowances-section">
			...
			>
				...
				<div class="section-header-text">
					<h2 class="section-title t-prose">Universal Allowances</h2>
		...
		<div class="allowances-section">
			...
			>
				...
				<div class="section-header-text">
					<h2 class="section-title t-prose">Grouped Allowances</h2>
...
<form method="POST" action="?/addGroupMember" use:enhance>
	...
	<div class="payroll-section">
			...
			>
				...
				<div class="section-header-text">
					<h2 class="section-title t-prose">Position Payroll</h2>
...
<form method="POST" action="?/adjustPositionAllowance" use:enhance>
		...
		<div class="transfer-section">
			...
			>
				...
				<div class="section-header-text">
					<h2 class="section-title t-prose">One-Off Transfers</h2>
...
<style>
	...
	/* success/error-message have font-size: text-base here (global uses text-sm) */
	.success-message {
