...
<div class="page-container page-container--content">
	<div class="page-header page-header--left">
		<h1 class="t-display">{data.guide.title}</h1>
		<p class="page-header-description">{data.guide.summary}</p>
	</div>

	<Subnav tabs={knowledgeTabs} />

	<div class="page-content">
		<article class="guide-content card-border">
...
<style>
	...
	.guide-content :global(h1:first-child),
	...
	.guide-content :global(code) {
		...
		background: color-mix(in srgb, var(--surface-muted) 85%, white 15%);
