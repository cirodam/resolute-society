		...
		<div class="day-panel card-border">
			...
			{#if form?.closeDaySuccess}
				<p class="form-success">
					...
					<a href="/dashboard/ledger/day/{form.date}">View & print</a>
				</p>
			{/if}
			...
			{:else if todayRecord.status === 'closed'}
				<div class="closed-day-info">
					...
					<div class="closed-day-actions">
						<a href="/dashboard/ledger/day/{todayRecord.date}" class="btn btn--secondary">
				...
				<div class="days-table card-border">
					...
					{#each recentDays as day}
						<div class="days-row">
							...
							<div>
								<a href="/dashboard/ledger/day/{day.date}" class="link-subtle">View</a>
							</div>
						</div>
					{/each}
				</div>
