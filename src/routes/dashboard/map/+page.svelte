...
<div class="page-container">
		...
		<div class="coord-capture">
			...
			{#if clickedLat !== null && clickedLng !== null}
				<div class="coord-actions">
					...
					{/if}
					<a href="/dashboard/locations?lat={clickedLat.toFixed(6)}&lng={clickedLng.toFixed(6)}" class="btn btn--primary">
						New Location Here
					</a>
				</div>
			{/if}
	...
	{#if !society.lat || !society.lng}
		<p class="no-coords">No coordinates set — click the map and use <em>Center Society Here</em>, or add them in <a href="/dashboard/settings">Settings</a>.</p>
	{/if}
</div>
