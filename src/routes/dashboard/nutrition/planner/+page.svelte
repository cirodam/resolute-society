...
<div class="page-container">
	<div class="page-header">
		<div class="section-header">
			...
			<a href="/dashboard/nutrition/planner/print" class="btn btn--secondary btn--small">Print Plan</a>
		</div>
	</div>
			...
			<div class="planner-layout">
				...
				<div class="food-inputs card-border">
					...
					{#each data.foods as food}
						<div class="food-row">
							<a href="/dashboard/nutrition/food/{food.id}" class="food-name">{food.name}</a>
							<input
								type="number"
								min="0"
								step="1"
			...
			<div class="food-catalog card-border">
				...
				{#each data.foods as food}
					<div class="catalog-row">
						<a href="/dashboard/nutrition/food/{food.id}" class="catalog-name">{food.name}</a>
