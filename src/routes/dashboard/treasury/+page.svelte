...
<div class="page-container">
	...
	<div class="page-content">
		...
		<div class="demurrage-section">
			...
			<Alert type="success" message={form?.fedMintSuccess ? `Minted ${form.minted.toFixed(2)} federation credits. Fed supply is now ${form.totalFedSupply?.toFixed(2)} against target ${form.expectedSupply.toFixed(2)}.` : null} />
