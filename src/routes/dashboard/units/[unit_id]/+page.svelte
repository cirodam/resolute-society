	...
	<div class="page-header">
		<div class="breadcrumb">
			{#if data.parentUnit}
				...
				<a href="/dashboard/units/{data.parentUnit.id}" class="breadcrumb-link">{data.parentUnit.name}</a>
				<span class="breadcrumb-sep">/</span>
			...
			{:else}
				<div class="sub-units-grid">
					{#each data.subUnits as sub}
						<a href="/dashboard/units/{sub.id}" class="sub-unit-card">
			...
			{:else}
				<div class="positions-list">
					{#each data.positions as pos}
						<a href="/dashboard/units/{data.unit.id}/{pos.id}" class="position-item">
